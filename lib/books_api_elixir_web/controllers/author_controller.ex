defmodule BooksApiElixirWeb.AuthorController do
  use BooksApiElixirWeb, :controller

  alias BooksApiElixir.Authors
  alias BooksApiElixir.Authors.Author

  action_fallback BooksApiElixirWeb.FallbackController

  def index(conn, _params) do
    author = Authors.list_author()
    render(conn, :index, authors: author)
  end
